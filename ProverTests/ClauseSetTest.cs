...
";
        ...
        [TestMethod]
        static void TestClauseSetChanges()
        {
            var lex = new Lexer(spec);
            var clauses = new ClauseSet();
            clauses.Parse(lex);
        ...
        public void testIndexedClauseSetChanges()
        {
            ...
            var lex = new Lexer(spec);
            var clauses = new IndexedClauseSet();
            clauses.Parse(lex);
        ...
        public void testResIndexedPositions()
        {
            ...
            var lexer = new Lexer("hates(X,agatha)");
            var lit = Literal.ParseLiteral(lexer);
            var pos = clauses.GetResolutionLiterals(lit);
